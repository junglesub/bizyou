...
// 부스 데이터 예시
const boothList = [
  { name: "포스코", tags: ["철강", "글로벌", "친환경"] },
  { name: "현대제철", tags: ["친환경 철강", "H형강", "자동차강판"] },
  { name: "동국제강", tags: ["철강", "건설", "컬러강판"] },
  { name: "세아제강", tags: ["강관", "에너지", "해상풍력"] },
  { name: "풍산", tags: ["비철금속", "방산", "신동"] },
  { name: "고려아연", tags: ["비철금속", "아연", "신재생에너지"] },
  { name: "LS MnM", tags: ["비철금속", "동제련", "희소금속"] },
  { name: "TCC스틸", tags: ["이차전지", "초정밀소재", "니켈도금강판"] },
  { name: "에코프로", tags: ["이차전지", "양극재", "친환경"] },
  { name: "포스코퓨처엠", tags: ["첨단소재", "이차전지", "음극재"] }, // 기존 포스코케미칼에서 사명 변경
  { name: "엘앤에프", tags: ["이차전지", "양극재", "나노소재"] },
  { name: "코스모신소재", tags: ["이차전지", "첨단소재", "MLCC"] },
  { name: "SK오션플랜트", tags: ["해상풍력", "에너지", "플랜트"] },
  { name: "대한제강", tags: ["철강", "철근", "스마트팩토리"] },
  { name: "한국철강", tags: ["철강", "단조", "특수강"] },
  { name: "RIST (포항산업과학연구원)", tags: ["연구기관", "R&D", "신기술"] },
  {
    name: "KITECH (한국생산기술연구원)",
    tags: ["연구기관", "뿌리기술", "제조혁신"],
  },
  { name: "두산에너빌리티", tags: ["에너지", "원자력", "가스터빈"] },
  { name: "효성중공업", tags: ["에너지", "수소", "전력기기"] },
  { name: "알루코", tags: ["비철금속", "알루미늄", "이차전지 부품"] },
  { name: "삼아알미늄", tags: ["비철금속", "알루미늄", "이차전지용 박"] },
  { name: "대창", tags: ["비철금속", "황동", "자동차 부품"] },
];
